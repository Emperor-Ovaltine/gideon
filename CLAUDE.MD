...
9. **`video_commands.py`** - AI video generation via OpenRouter
   ...
   - Discord model autocomplete returns a cached/fallback model list immediately and refreshes the live OpenRouter model list in the background to stay within Discord's interaction deadline
