...
* **Settings Management** - Edit global settings, channel overrides, and tool calling from the browser
...
| Settings | Edit global model, provider, system prompt, memory limits, and tool calling |
